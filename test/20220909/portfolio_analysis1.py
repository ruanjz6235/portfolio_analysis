...
def get_asset_and_valuation_appreciation_ratio_change(request_id, type, fund_zscode, start_date, end_date):
    ...
    asset_ratio_change = get_asset_allocation_change(
        request_id, type, fund_zscode, start_date, end_date)
...
def get_asset_allocation_change(request_id, type, fund_zscode, start_date, end_date):
...
#    logger.info(bond_portfolio)
    ...
    if len(bond_codes) > 0:
        ...
        logger.info(bond_average_weight)
